...
tracks.id,tracks.title,tracks.description,tracks.uid,users.first_name,users.last_name,tracks.name,tracks.tag,tracks.art,tracks.buy,tracks.record,tracks.release,tracks.license,tracks.size,tracks.download,tracks.time,tracks.public,tracks.likes ,tracks.downloads,tracks.views from tracks join users on users.idu = tracks.uid where tracks.public = '1' ORDER BY tracks.likes DESC limit 10");
       $num = $query->num_rows;
